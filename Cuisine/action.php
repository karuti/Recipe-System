				...
				echo "<div class='col-md-4'>
							<div class='panel panel-danger'>
								...
								<a href='#' class='imageproduct' pid='$pro_id'>
									<img src='assets/prod_images/$img' style='width:420px; height:350px;' >
								</a>
								</div>
								<div class='panel-heading'>Ingredients price in Ksh $price
	...
	if(isset($_POST['cartmenu']) || isset($_POST['cart_checkout']))
	{
		...
		while($row=mysqli_fetch_array($run_query))
		{
			...
			if(isset($_POST['cartmenu']))
			{
				echo "
				<div class='row'>
									<div class='col-md-4'>$sl</div>
									<div class='col-md-4'>$product_title</div>
									<div class='col-md-4'>Ksh $product_price</div>
		...
		echo "
				<div class='row'>
					...
					<div class='col'>
						...
						<img class='ml-5 mr-5' src='assets/prod_images/$image' style='width:400px;height:350px;'>
						<button pid='$pro_id' class='product btn btn-danger'>Add to Cart</button>
				<center>
						<div class='row'> <div class='col-md-12'><h1>$title</h1></div></div></center>
